...
const HostDashboard = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const result = await res.json();
            if (result.success) {
                const unreadOnly = result.data.filter((note) => !note.read);
        ...
        <div className="host-dashboard">
            ...
            <aside className="sidebar">
                ...
                <ul>
                    ...
                    <li className={activeTab==='visitors'?'active':''} onClick={()=>setActiveTab('visitors')}>My Visitors</li>
